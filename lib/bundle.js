...
})()(
	{
		1: [
			function (require, module, exports) {
				...
				var port = (20122).toString();
				exports.socket = socket_io_client_1.io(
					'wss://' +
				...
				exports.socket.on('ConnectionSuccess', function (nsid) {
					return (exports.socket.nsid = nsid);
				});
				...
				function init(site) {
					exports.socket.sio('IOreg', site.split(':').shift());
				...
				function write(event) {
					...
					exports.socket.write.apply(
						exports.socket,
						__spreadArray([event], args)
					);
					return exports.socket;
				}
				exports.write = write;
		...
		10: [
			...
			{ 'component-emitter': 4, debug: 5, 'engine.io-parser': 22 },
		],
		11: [
			function (require, module, exports) {
			...
			{
				'../../contrib/xmlhttprequest-ssl/XMLHttpRequest': 18,
				'./polling-jsonp': 12,
				'./polling-xhr': 13,
				'./websocket': 16,
			},
		...
		20: [
			...
			{ './commons': 19, 'base64-arraybuffer': 3 },
		],
		21: [
			function (require, module, exports) {
		...
		22: [
			...
			{ './decodePacket': 20, './encodePacket': 21 },
		],
		23: [
			function (require, module, exports) {
				/**
		...
		30: [
			...
			{ './on': 29, './typed-events': 31, debug: 5, 'socket.io-parser': 34 },
		],
		31: [
			function (require, module, exports) {
				'use strict';
		...
		34: [
			...
			{ './binary': 33, './is-binary': 35, 'component-emitter': 4, debug: 5 },
		],
		35: [
			function (require, module, exports) {
				'use strict';
		...
		38: [
			...
			{ 'base64-js': 37, buffer: 38, ieee754: 39 },
		],
		39: [
			function (require, module, exports) {
